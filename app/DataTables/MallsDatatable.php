...
class MallsDatatable extends DataTable
{
    ...
    public function dataTable($query)
    {
        return datatables()
            ->eloquent($query)
            ->addColumn('action', 'adminlte.malls.datatables.action')
            ->addColumn('checkbox', 'adminlte.malls.datatables.checkbox')
        ...
        return $this->builder()
            ...
            ->buttons(
                Button::make('create')
                    ...
                    ->text('<i class="fa fa-plus"></i> ' . __('dataTables.buttons.create mall')),
                Button::make('print')
