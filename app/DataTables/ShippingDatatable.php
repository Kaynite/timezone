...
class ShippingDatatable extends DataTable
{
    ...
    public function dataTable($query)
    {
        return datatables()
            ->eloquent($query)
            ->addColumn('action', 'adminlte.shipping.datatables.action')
            ->addColumn('checkbox', 'adminlte.shipping.datatables.checkbox')
            ->rawColumns(['action', 'checkbox']);
    }

    public function query(Shipping $model)
    {
        return $model->with('user')->locale()->newQuery();
    }
        ...
        return $this->builder()
            ...
            ->buttons(
                Button::make('create')
                    ...
                    ->text('<i class="fa fa-plus"></i> ' . __('dataTables.buttons.create shipping')),
                Button::make('print')
