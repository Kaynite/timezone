...
class TrashProductsDatatable extends DataTable
{
    /**
    ...
    public function dataTable($query)
    {
        return datatables()
            ->eloquent($query)
            ->addColumn('action', 'adminlte.products.datatables.trash')
    ...
    {
        return $model->onlyTrashed()->with(['category' => function($q) { $q->locale(); }])->locale()->newQuery();
    }
        ...
        return $this->builder()
            ...
            ->buttons(
                Button::make('create')
                    ...
                    ->text('<i class="fa fa-plus"></i> ' . __('dataTables.buttons.create product')),
                Button::make('print')
