...
class TrademarlsDatatable extends DataTable
{
    /**
    ...
    public function dataTable($query)
    {
        return datatables()
            ->eloquent($query)
            ->addColumn('action', 'adminlte.trademarks.datatables.action')
            ->addColumn('checkbox', 'adminlte.trademarks.datatables.checkbox');
    }
        ...
        return $this->builder()
            ...
            ->buttons(
                Button::make('create')
                    ...
                    ->text('<i class="fa fa-plus"></i> ' . __('dataTables.buttons.create trademark')),
                Button::make('print')
