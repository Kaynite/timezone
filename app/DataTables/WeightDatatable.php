...
class WeightDatatable extends DataTable
{
    ...
    public function dataTable($query)
    {
        return datatables()
            ->eloquent($query)
            ->addColumn('action', 'adminlte.weight.datatables.action')
            ->addColumn('checkbox', 'adminlte.weight.datatables.checkbox')
        ...
        return $this->builder()
            ...
            ->buttons(
                Button::make('create')
                    ...
                    ->text('<i class="fa fa-plus"></i> ' . __('dataTables.buttons.create weight')),
                Button::make('print')
