                ...
                <form action="{{ route('states.store') }}" method="POST">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="name_ar" name="name_ar" placeholder="{{ __('admin.states.form.name_ar placeholder') }}" required>
                            @error('name_ar')
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="name_en" name="name_en" placeholder="{{ __('admin.states.form.name_en placeholder') }}" required>
                            @error('name_en')
                            <small class="form-text text-danger">{{ $message }}</small>
                            @enderror
                        </div>
                        ...
                        <div class="form-group">
                            <label for="city_id">{{ __('admin.cities.form.city') }}</label>
