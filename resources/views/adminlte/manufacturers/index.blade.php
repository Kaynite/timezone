        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">{{ __('admin.manufacturers.index title') }}</h3>
                </div>
                <div class="card-body">
                    <div class="row">
                        <form id="multipleDeleteForm" class="w-100" action="{{ route('manufacturers.multipleDelete') }}" method="POST">
                            @csrf
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalTitle">{{ __('admin.manufacturers.modal.title') }}</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <div class="modal-body">
                    {{ __('admin.manufacturers.modal.body') }}
                </div>
...
@section('title')
{{ __('admin.manufacturers.index title') }}
@endsection
