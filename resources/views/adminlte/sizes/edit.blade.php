                    ...
                    <div class="card-body">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="name_ar" name="name_ar" placeholder="{{ __('admin.sizes.form.name_ar placeholder') }}" value="{{ $size->name_ar }}">
                                @error('name_ar')
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="name_en" name="name_en" placeholder="{{ __('admin.sizes.form.name_en placeholder') }}" value="{{ $size->name_en }}">
                                @error('name_en')
                                <small class="form-text text-danger">{{ $message }}</small>
                                @enderror
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div id="jstree"></div>
                                <input type="hidden" name="category_id" value="{{ $size->category_id }}" id="category_id">
                                @error('category_id')
