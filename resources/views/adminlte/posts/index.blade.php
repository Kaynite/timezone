    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body">
                    <div class="row">
                        <form id="multipleDeleteForm" class="w-100" action="{{ route('posts.multipleDelete') }}" method="POST">
                            @csrf
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalTitle">{{ __('admin.posts.modal.title') }}</h5>
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" onclick="multipleDeleteSubmit()" class="btn btn-danger">{{ __('admin.posts.modal.delete') }}</button>
                </div>
            </div>
        </div>
    </div>
